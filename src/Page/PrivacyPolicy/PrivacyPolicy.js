...
const PrivacyPolicy = () => {
    return (
        <div className='PrivacyPolicy'>
            ...
            <Link className='NewIcon' to='/home'>
            ...
            <p>Thank you for joining BookReader
. We at BookReader (BookReader, “Book”, “Reader” It's BookReader) respect your privacy and want you to understand how we collect, use, and share data about you. This Privacy Policy covers our data collection practices and describes your rights regarding your personal data.

                Unless we link to a different policy or state otherwise, this Privacy Policy applies when you visit or use the BookReader and CorpU websites, mobile applications, APIs, or related services, including CorpU Open (the “Services”). It also applies to prospective customers of our business and enterprise products.
...
As permitted by applicable law, if you continue to use the Services after the effective date of any change, then your access and/or use will be deemed an acceptance of (and agreement to follow and be bound by) the revised Privacy Policy. The revised Privacy Policy supersedes all previous Privacy Policies.</p>
                            ...
                            <div id='questions' className="Data">
                                ...
                                <p>If you have any questions, concerns, or disputes regarding our Privacy Policy, please feel free to contact our privacy team (including our Data Protection Officer) at bookReader@gmail.com. You can also send postal mail to us at bookReader, 	1216 Mirpur 01 Dhaka Bangladesh.</p>
                            </div>
